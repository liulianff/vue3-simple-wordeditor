...
| `.crop-box`                    | 裁剪框        | `position: absolute; border: 2px solid var(--editor-bg-color, #fff); outline: 1px solid var(--editor-border-color, rgba(0,0,0,0.3)); cursor: move; will-change: left, top, width, height` |
| `.crop-handle`                 | 裁剪框手柄      | `position: absolute; width: 16px; height: 16px; background: var(--editor-bg-color, #fff); border: 1px solid var(--editor-border-color, #666)`                                      |
| `.crop-handle.handle-nw`       | 左上角手柄      | `top: -8px; left: -8px; cursor: nw-resize`                                                                                                                                         |
| `.crop-handle.handle-n`        | 上方手柄       | `top: -8px; left: 50%; margin-left: -8px; cursor: n-resize`                                                                                                                        |
| `.crop-handle.handle-ne`       | 右上角手柄      | `top: -8px; right: -8px; cursor: ne-resize`                                                                                                                                        |
| `.crop-handle.handle-e`        | 右侧手柄       | `top: 50%; right: -8px; margin-top: -8px; cursor: e-resize`                                                                                                                        |
| `.crop-handle.handle-se`       | 右下角手柄      | `bottom: -8px; right: -8px; cursor: se-resize`                                                                                                                                     |
| `.crop-handle.handle-s`        | 下方手柄       | `bottom: -8px; left: 50%; margin-left: -8px; cursor: s-resize`                                                                                                                     |
| `.crop-handle.handle-sw`       | 左下角手柄      | `bottom: -8px; left: -8px; cursor: sw-resize`                                                                                                                                      |
| `.crop-handle.handle-w`        | 左侧手柄       | `top: 50%; left: -8px; margin-top: -8px; cursor: w-resize`                                                                                                                         |
